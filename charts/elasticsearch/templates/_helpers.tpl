...
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-base:{{ .Values.images.init.tag }}
{{- else -}}
...
{{- if .Values.global.privateRegistry.enabled -}}
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-elasticsearch:{{ .Values.images.es.tag }}
{{- else -}}
...
{{- if .Values.global.privateRegistry.enabled -}}
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-curator:{{ .Values.images.curator.tag }}
{{- else -}}
...
{{- if .Values.global.privateRegistry.enabled -}}
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-elasticsearch-exporter:{{ .Values.images.exporter.tag }}
{{- else -}}
...
{{- if .Values.global.privateRegistry.enabled -}}
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-nginx-es:{{ .Values.images.nginx.tag }}
{{- else -}}
