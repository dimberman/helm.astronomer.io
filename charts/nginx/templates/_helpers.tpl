...
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-nginx:{{ .Values.images.nginx.tag }}
{{- else -}}
...
{{- if .Values.global.privateRegistry.enabled -}}
{{ .Values.global.privateRegistry.privateRegistryRepoName }}/ap-default-backend:{{ .Values.images.defaultBackend.tag }}
{{- else -}}
